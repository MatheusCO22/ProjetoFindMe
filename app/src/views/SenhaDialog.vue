	...
	export default {
      ...
      const defaultForm = Object.freeze({
        ...
        this.$refs.form.reset()
          ...
          this.$parent.$parent.$parent.$parent.$parent.$parent.$children[1].openSnack('success', 'Verifique seu e-mail para restaurar sua senha')
          this.close()
        }).catch((err)=>{
          console.log(err, 'ERRO')
          this.$parent.$parent.$parent.$parent.$parent.$parent.$children[1].openSnack('error', 'E-mail não encontrado.')
        })
			}
		}
	}
